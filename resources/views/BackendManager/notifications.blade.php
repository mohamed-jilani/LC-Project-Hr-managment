        ...
        <div class="card mt-4">
          ...
          <div class="card-body p-3 pb-0">
            ...
            @foreach($notifications as $notification)
              @if($notification->etat_name == "en cours")  
              <!--tache_user_name ,tache_description ,tache_dateCreation ,etat_name -->              

              <div class="alert alert-info alert-dismissible text-white" role="alert">
                <span class="text-sm">{{$notification->tache_user_name}} a été ajoutée une tache avec la description {{$notification->tache_description}} , le : {{$notification->tache_dateCreation}} , etat : {{$notification->etat_name}} </span>
                <button type="button" class="btn-close text-lg py-3 opacity-10" data-bs-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              
                @elseif ($notification->etat_name == "en attente")
                ...
                @elseif ($notification->etat_name == "terminé")
