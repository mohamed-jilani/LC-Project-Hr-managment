...
<div class="container">
  <div class="row">
    <div class="col s12">
      ...
      <a href="/ajouter/{{ $semaine[0] }}" class="btn btn-danger"> ajouter</a>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">{{ $tach->created_at }}</span>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold">{{ $tach->updated_at }}</span>
                      </td>
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Vendredi  
                  ...
                  <a href="/ajouter/{{ $semaine[4] }}" class="btn btn-warning float-end"> ajouter</a>
                </h6>
