...
<div class="container">
  <div class="row">
    <div class="col s12">
      ...
      <a href="hr/ajouter" class="btn btn-danger"> ajouter</a>
                ...
                <h6 class="text-white text-capitalize ps-3">Lundi      
                  <span class="text-xs font-weight-bold">{{ $semaine[0] }}</span>
                    @if(\Carbon\Carbon::parse($semaine[0])->toDateString() == now()->toDateString())
                      <a href="hr/ajouter/{{ $semaine[0] }}" class="btn btn-warning float-end">Ajouter</a>
                    @endif
                </h6>
              </div>
            </div>
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
         ...
         <a href="hr/ajouter/{{ $semaine[1] }}" class="btn btn-warning float-end">Ajouter</a>
          @endif
          </h6>
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
         ...
         <a href="hr/ajouter/{{ $semaine[2] }}" class="btn btn-warning float-end">Ajouter</a>
          @endif
          </h6>
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
         ...
         <a href="hr/ajouter/{{ $semaine[3] }}" class="btn btn-warning float-end">Ajouter</a>
          @endif
          </h6>
