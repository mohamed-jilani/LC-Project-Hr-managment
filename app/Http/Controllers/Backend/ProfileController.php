...
class ProfileController extends Controller
{
    ...
    return view('Backend.profile', ['users' => $users]);
}
...
public function updateProfile(Request $request)
{
    ...
    if ($authUser !== null) {
        ...
        return redirect('/profile_hr')->with('status', 'Modification réussie.');
    } else {
        // Authenticated user not found
        return redirect('/profile_hr')->with('error', 'Utilisateur introuvable.');
    }
}
